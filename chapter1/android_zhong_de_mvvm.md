...
到这里，如果说MVVM在MVC中的应用结束的话，未免有点得不偿失，毕竟我们可以通过其它的方式来优化MVC（比如[MPV](https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93presenter)等）。别忘记我们在将MVVM时说过MVVM有个数据绑定的特性，那么接下来，我们进入下一章，**[数据绑定在MVVM中的应用]((./android_zhong_de_mvvm.md))**。